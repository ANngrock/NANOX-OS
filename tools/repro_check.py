...
and in the working tree, and requires BOOTX64.EFI, kernel.elf and nanox.img to
be byte-identical across all three builds.  Writes out/repro-check.json.
...
ARTIFACTS = ("BOOTX64.EFI", "kernel.elf", "nanox.img")
